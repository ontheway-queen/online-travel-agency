...
class BtocFlightBookingModel extends schema_1.default {
    constructor(db) {
        super();
        this.db = db;
    }
    // get all flight booking
    getAdminAllFlightBooking(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const { limit, skip, status, user_id, from_date, to_date, name, pnr } = payload;
            console.log({ payload });
            const baseQuery = this.db("b2c.flight_booking as fb").leftJoin("b2c.users as us", "us.id", "fb.user_id");
            const dataQuery = baseQuery
                .clone()
                .select("fb.id", "us.id as user_id", "us.username as created_by", "fb.pnr_code", "fb.total_passenger", "fb.status", "fb.payable_amount", "fb.discount", "fb.api", "fb.journey_type", "fb.created_at", "fb.route", "fb.platform", "fb.booking_id as booking_ref", this.db("b2c.flight_segment as fs")
    ...
    getSingleFlightBooking(wherePayload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.db("flight_booking as fb")
                ...
                .select("fb.id", "us.username as created_by", "us.id as user_id", "us.first_name", "us.last_name", "us.email", "fb.pnr_code", "fb.total_passenger", "fb.status", "fb.base_fare", "fb.total_tax", "fb.payable_amount", "fb.ait", "fb.discount", "fb.journey_type", "fb.created_at", "fb.convenience_fee", "fb.api", "fb.route", "fb.last_time", "fb.booking_id as booking_ref", "fb.airline_pnr", "fb.vendor_price", "in.due", "in.id as invoice_id", "in.invoice_number", this.db.raw('"in"."total_amount" - "in"."due" as "paid_amount"'), "fb.api_booking_ref", "fb.ticket_issued_on")
    ...
    //get fight travelers
    getFlightTraveler(flight_booking_id, id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getFlightBookingList(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const data = yield this.db("flight_booking as fb")
                .withSchema(this.BTOC_SCHEMA)
                .select("fb.id as booking_id", "fb.total_passenger", "fb.status", "fb.payable_amount", "fb.discount", "fb.convenience_fee", "fb.journey_type", "fb.created_at", "fb.route", "fb.pnr_code", "in.due", "in.id as invoice_id", this.db("flight_segment as fs")
                .withSchema(this.BTOC_SCHEMA)
                .select("fs.departure_date")
                .whereRaw("fs.flight_booking_id = fb.id")
                .orderBy("fs.departure_date", "asc")
            ...
            return { data, total: parseInt((_a = total === null || total === void 0 ? void 0 : total[0]) === null || _a === void 0 ? void 0 : _a.total) };
        });
    }
    ...
    //update travelers
    updateTravelers(payload, id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.db("flight_booking_traveler")
                .withSchema(this.BTOC_SCHEMA)
                .update(payload)
                .where({ id });
        });
    ...
    getPendingTicketIssuance(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.db("pending_flight_ticket_issuance as pti")
                .withSchema(this.BTOC_SCHEMA)
                .select("pti.id", "fb.booking_id as booking_ref", "fb.pnr_code", "fb.total_passenger", "fb.route", "fb.payable_amount", "pti.api", "fb.status as booking_status", "pti.status as ticket_request_status", "pti.created_at")
    ...
    updateTicketIssuance(payload, id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.db("pending_flight_ticket_issuance")
                .withSchema(this.BTOC_SCHEMA)
                .update(payload)
                        ...
                        qb.where(function () {
                            this.whereRaw('LOWER(fbt.first_name) = ?', [p.first_name.toLowerCase()])
                                ...
                                subQb
                                    ...
                                    .orWhere("fbt.email", (_b = p.email) !== null && _b !== void 0 ? _b : null);
                                subQb
                                    .whereNotNull("fbt.contact_number")
                                    .orWhere("fbt.contact_number", (_c = p.phone) !== null && _c !== void 0 ? _c : null);
                            });
                        });
                    }
                    else {
    ...
    createFlightBookingSSR(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("flight_booking_ssr")
                .withSchema(this.BTOC_SCHEMA)
                .insert(payload, 'id');
        });
    }
    getFlightBookingSSR(flight_booking_id) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.db("flight_booking_ssr as fbss")
                ...
                .select("fbss.id", "fbs.origin", "fbs.destination", "fbt.title", "fbt.first_name", "fbt.last_name", "fbss.amount", "fbss.description")
                .where("fbss.booking_id", flight_booking_id);
            return data;
        });
    }
}
exports.default = BtocFlightBookingModel;
