...
exports.B2BRefundRequestModel = void 0;
const schema_1 = __importDefault(require("../../utils/miscellaneous/schema"));
class B2BRefundRequestModel extends schema_1.default {
    constructor(db) {
        super();
        this.db = db;
    }
    createRefundRequest(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("refund_request")
                .withSchema(this.AGENT_SCHEMA)
                .insert(payload, "id");
        });
    }
    createRefundRequestTickets(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("refund_request_tickets")
                .withSchema(this.AGENT_SCHEMA)
                .insert(payload, "id");
        });
    }
    updateRefundRequest(payload, id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("refund_request")
                .withSchema(this.AGENT_SCHEMA)
                .update(payload)
    ...
    getRefundRequestList(query_1) {
        return __awaiter(this, arguments, void 0, function* (query, is_total = false) {
            var _a;
            const data = yield this.db("view_refund_request")
                .withSchema(this.AGENT_SCHEMA)
            ...
            let total = [];
            if (is_total) {
                total = yield this.db("view_refund_request")
                    .withSchema(this.AGENT_SCHEMA)
                    .count("id as total")
                    .where((qb) => {
                    if (query.status) {
    ...
    getSingleRefundRequest(where) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("view_refund_request")
                .withSchema(this.AGENT_SCHEMA)
                .select("*")
                .where((qb) => {
                if (where.id) {
    ...
    getRefundRequestTickets(refund_request_id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db("refund_request_tickets")
                .withSchema(this.AGENT_SCHEMA)
                .select("*")
...
exports.B2BRefundRequestModel = B2BRefundRequestModel;
