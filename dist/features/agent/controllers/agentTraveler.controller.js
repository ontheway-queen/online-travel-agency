...
const btobTraveler_service_1 = __importDefault(require("../services/btobTraveler.service"));
const btobTraveler_validator_1 = __importDefault(require("../utils/validators/btobTraveler.validator"));
class BtobTravelerController extends abstract_controller_1.default {
    constructor() {
        super();
        this.service = new btobTraveler_service_1.default();
        this.validator = new btobTraveler_validator_1.default();
...
exports.default = BtobTravelerController;
