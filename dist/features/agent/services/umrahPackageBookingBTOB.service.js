...
class UmrahPackageBookingBTOBService extends abstract_service_1.default {
    //create umrah package booking for b2b
    createUmrahPackageBooking(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const { b2b_price_per_person, b2b_discount, b2b_discount_type } = umrahPackage;
                const price = Number(b2b_price_per_person) * Number(rest.traveler_adult);
                const new_price = b2b_discount_type === 'FLAT'
                    ? Number(price) - Number(b2b_discount)
                    : Number(price) - (Number(price) * Number(b2b_discount)) / 100;
                const umrah_package_booking = yield bookingModel.insertUmrahPackageBookingB2B({
                    umrah_id,
                    agency_id,
                    created_by: user_id,
                ...
                yield bookingModel.insertUmrahPackageBookingContactB2B(Object.assign({ booking_id }, booking_info));
                //create invoice
    ...
    getAgencyBookingHistory(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const { agency_id } = req.agency;
            const { limit, skip } = req.query;
            const model = this.Model.umrahPackageBookinModel();
            const { history, historyCount } = yield model.getAgencyBookingHistory({
                agency_id,
                limit,
                skip,
            });
    ...
    getSingleBooking(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const model = this.Model.umrahPackageBookinModel();
            const data = yield model.getSingleBTOBBooking(Number(id));
            return {
                success: true,
                code: this.StatusCode.HTTP_OK,
                message: this.ResMsg.HTTP_OK,
...
exports.default = UmrahPackageBookingBTOBService;
