    ...
    createSupport(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                //   }'.`,
                // });
                const agency = yield this.Model.agencyModel(trx).getSingleAgency(agency_id);
                //send mail
                yield lib_1.default.sendEmail([constants_1.PROJECT_EMAIL_API_1], `B2B Support Created for booking id ${booking_ref} | ${constants_1.PROJECT_NAME}`, (0, bookingSupportTemplate_1.BookingSupportTemplate)({
    ...
    createMessage(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                //send mail
                yield lib_1.default.sendEmail([constants_1.PROJECT_EMAIL_API_1], `New incoming message from B2B support for booking id ${booking_data[0].booking_ref} | ${constants_1.PROJECT_NAME}`, (0, bookingSupportTemplate_1.BookingSupportTemplate)({
