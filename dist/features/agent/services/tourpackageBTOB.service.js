...
class TourPackageBTOBService extends abstract_service_1.default {
    // get Tour Package List
    tourPackageList(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const model = this.Model.tourPackageModel();
            const query = req.query;
            const data = yield model.getTourPackageListV2(Object.assign(Object.assign({}, query), { s_type: "b2b" }));
...
exports.default = TourPackageBTOBService;
