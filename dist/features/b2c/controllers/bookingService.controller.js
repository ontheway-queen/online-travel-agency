...
const B2CBookingSupportValidator_1 = require("../utils/validators/B2CBookingSupportValidator");
class BtoCBookingServiceController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new bookingService_service_1.BtoCBookingService();
...
exports.default = BtoCBookingServiceController;
