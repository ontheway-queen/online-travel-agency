...
exports.BookingVisaController = void 0;
...
class BookingVisaController extends abstract_controller_1.default {
    constructor() {
        super(...arguments);
        this.service = new bookingVisa_service_1.BookingVisaService();
...
exports.BookingVisaController = BookingVisaController;
