...
exports.AdminBtoCBookingSupportController = void 0;
const abstract_controller_1 = __importDefault(require("../../../abstract/abstract.controller"));
const B2CBookingSupportValidator_1 = require("../../b2c/utils/validators/B2CBookingSupportValidator");
const admin_b2cBookingService_service_1 = require("../services/admin.b2cBookingService.service");
class AdminBtoCBookingSupportController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new admin_b2cBookingService_service_1.AdminBtoCBookingService();
        this.validators = new B2CBookingSupportValidator_1.B2CBookingSupportValidator();
        // get
        ...
        this.closeSupport = this.asyncWrapper.wrap({
            ...
            const _a = yield this.services.closeSupport(req), { code } = _a, rest = __rest(_a, ["code"]);
            res.status(code).json(rest);
        }));
    }
}
exports.AdminBtoCBookingSupportController = AdminBtoCBookingSupportController;
