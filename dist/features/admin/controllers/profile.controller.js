...
const profile_validator_1 = __importDefault(require("../utils/validators/profile.validator"));
class AdminProfileController extends abstract_controller_1.default {
    constructor() {
        super();
        this.profileService = new profile_service_1.default();
        this.profileValidator = new profile_validator_1.default();
        //get profile
        ...
        //edit profile
        this.editProfile = this.asyncWrapper.wrap({ bodySchema: this.profileValidator.editProfile }, (req, res) => __awaiter(this, void 0, void 0, function* () {
