...
const B2BBookingSupportValidator_1 = require("../../agent/utils/validators/B2BBookingSupportValidator");
class AdminBtoBBookingServiceController extends abstract_controller_1.default {
    constructor() {
        super();
        this.services = new admin_b2bBookingService_service_1.AdminBtoBBookingService();
