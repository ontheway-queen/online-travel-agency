...
class AdministrationService extends abstract_service_1.default {
    ...
    createAdmin(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //send email to admin
            yield lib_1.default.sendEmail([constants_1.PROJECT_EMAIL_OTHERS_1], `New admin has been created`, (0, adminNotificationTemplate_1.email_template_to_send_notification)({
                title: "New admin has been created",
                details: {
                    details: `New admin has been created`
                }
            }));
            return {
                success: true,
