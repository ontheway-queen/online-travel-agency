...
exports.AdminBtoCBookingService = void 0;
...
class AdminBtoCBookingService extends abstract_service_1.default {
    constructor() {
        super();
    }
    //get list
    ...
    createMessage(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //send mail
            yield lib_1.default.sendEmail(support_data[0].created_by_email, `New incoming message from B2C support for booking id ${booking_data[0].booking_ref} | ${constants_1.PROJECT_NAME}`, (0, bookingSupportTemplate_1.BookingSupportTemplate)({
            ...
            //send mail
            yield lib_1.default.sendEmail([constants_1.PROJECT_EMAIL_OTHERS_1], `New incoming message from B2C support for booking id ${booking_data[0].booking_ref} | ${constants_1.PROJECT_NAME}`, (0, bookingSupportTemplate_1.BookingSupportTemplate)({
                bookingId: booking_data[0].booking_ref,
                supportType: support_data[0].support_type,
                createdBy: support_data[0].created_by,
                createdAt: support_data[0].created_at,
    ...
    closeSupport(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                //send email to admin
                yield lib_1.default.sendEmail([constants_1.PROJECT_EMAIL_OTHERS_1], `B2C Booking support has been closed`, (0, adminNotificationTemplate_1.email_template_to_send_notification)({
...
exports.AdminBtoCBookingService = AdminBtoCBookingService;
