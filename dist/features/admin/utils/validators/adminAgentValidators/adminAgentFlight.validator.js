    ...
    constructor() {
        ...
        this.updateBooking = joi_1.default.object({
            status: joi_1.default.string()
                .valid(flightConstants_1.FLIGHT_TICKET_ISSUE, flightConstants_1.FLIGHT_BOOKING_CANCELLED, flightConstants_1.FLIGHT_BOOKING_VOID, flightConstants_1.FLIGHT_BOOKING_REFUNDED, flightConstants_1.FLIGHT_BOOKING_CONFIRMED)
                .required(),
            ...
            deduction_amount: joi_1.default.number().when("status", {
        ...
        this.pnrShare = joi_1.default.object({
            supplier: joi_1.default.string().valid(flightConstants_1.SABRE_API, flightConstants_1.TRIPJACK_API).required(),
            pnr: joi_1.default.when("supplier", {
                is: flightConstants_1.SABRE_API,
                then: joi_1.default.string().required(),
                otherwise: joi_1.default.string().optional(),
            }),
            supplier_booking_ref: joi_1.default.when("supplier", {
                is: flightConstants_1.TRIPJACK_API,
                then: joi_1.default.string().required(),
                otherwise: joi_1.default.string().optional(),
            }),
        ...
        this.manualBookingSchema = joi_1.default.object({
            ...
            status: joi_1.default.string()
                ...
                .required(),
            payment: joi_1.default.string().valid("full", "partial", "paid").when("status", {
                is: flightConstants_1.FLIGHT_TICKET_ISSUE,
                then: joi_1.default.required(),
                otherwise: joi_1.default.forbidden(),
            }),
            partial_payment_rules: this.jsonStringParser(joi_1.default.object({
                payment_percentage: joi_1.default.number().required(),
                payment_last_day: joi_1.default.date().required(),
            })).when("payment", {
                is: "partial",
                then: joi_1.default.required(),
                otherwise: joi_1.default.forbidden(),
        ...
        this.editBookingInfo = joi_1.default.object({
            ...
            partial_payment: joi_1.default.boolean().allow(""),
            payment_percentage: joi_1.default.number().allow(""),
            payment_last_date: joi_1.default.date().allow(""),
