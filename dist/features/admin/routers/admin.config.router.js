...
const admin_config_controller_1 = __importDefault(require("../controllers/admin.config.controller"));
class AdminConfigRouter extends abstract_router_1.default {
    constructor() {
        super();
        this.controller = new admin_config_controller_1.default();
        this.callRouter();
    }
    callRouter() {
        //create city
        ...
        this.router
            .route("/airlines")
            .post(this.uploader.cloudUploadRaw(this.fileFolders.AIRLINES_FILES), this.controller.insertAirlines);
        //update, delete airlines
        this.router
            .route("/airlines/:id")
            .patch(this.uploader.cloudUploadRaw(this.fileFolders.AIRLINES_FILES), this.controller.updateAirlines)
