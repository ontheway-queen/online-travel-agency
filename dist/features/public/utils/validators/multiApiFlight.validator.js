...
class MultiAPIFlightValidator {
    constructor() {
        ...
        this.flightSearchSchema = joi_1.default.object({
            ...
            airline_code: joi_1.default.array().items({ Code: joi_1.default.string().required() }),
        ...
        this.flightSearchSSESchema = joi_1.default.object({
            ...
            promotion_code: joi_1.default.string().optional(),
        });
        ...
        //FARE RULES SCHEMA
        this.fareRulesSchema = joi_1.default.object({
            search_id: joi_1.default.string().required(),
            flight_id: joi_1.default.string().required(),
        });
        ...
        this.flightBookingPassengersSchema = joi_1.default.object({
            ...
            contact_email: joi_1.default.string().email().trim().lowercase().optional(),
        ...
        this.flightBooking = joi_1.default.object({
            search_id: joi_1.default.string().required(),
            flight_id: joi_1.default.string().required(),
        ...
        this.ticketIssueSchema = joi_1.default.object({
            payment_type: joi_1.default.string().valid("partial", "full").required(),
        });
    }
}
exports.default = MultiAPIFlightValidator;
