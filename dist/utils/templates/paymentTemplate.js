...
exports.agentTopUpSuccessTemplate = exports.paymentSuccessTemplate = void 0;
const constants_1 = require("../miscellaneous/constants");
const paymentSuccessTemplate = (payload) => {
    const getPaymentUsingLabel = (method) => {
...
const agentTopUpSuccessTemplate = (payload) => {
    const getPaymentUsingLabel = (method) => {
        switch (payload.paymentMethod.toUpperCase()) {
            case 'CARD':
                return 'Card Number';
...
exports.agentTopUpSuccessTemplate = agentTopUpSuccessTemplate;
