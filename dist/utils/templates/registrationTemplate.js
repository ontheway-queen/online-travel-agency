...
exports.agentRegistrationTemplate = exports.registrationTemplate = void 0;
const constants_1 = require("../miscellaneous/constants");
const registrationTemplate = (payload) => {
    return `
    <!DOCTYPE html>
<html lang="en">
<head>
...
exports.registrationTemplate = registrationTemplate;
const agentRegistrationTemplate = (payload) => {
    return `
    <!DOCTYPE html>
<html lang="en">
<head>
...
<body style="margin: 0; padding: 0; font-family: 'Poppins', sans-serif; background-color: #f7f9fc; color: #333;">
    <div style="max-width: 450px; margin: 20px auto; background: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); border: 1px solid #e7e9ec;">
        ...
        <div style="background-color: #f1f5fa; text-align: center; padding: 10px; font-size: 12px; color: #666;">
            <p style="margin: 5px 0;">Need help? Call us at <strong>${constants_1.PROJECT_NUMBER}</strong>.</p>
            <p style="margin: 5px 0;">Visit our website at <a href="" target="_blank" style="color: #0085D4; text-decoration: none;">${constants_1.BTOB_URL}</a>.</p>
            <p style="margin: 5px 0;">&copy; 2025 online travel agency. All Rights Reserved.</p>
        </div>
    </div>
</body>
...
exports.agentRegistrationTemplate = agentRegistrationTemplate;
