...
exports.AgencyRegistrationRequestRejectedTemplate = exports.AgencyRegistrationRequestApprovedTemplate = exports.newAgencyAccount = void 0;
const constants_1 = require("../miscellaneous/constants");
const newAgencyAccount = (email, password) => {
    return `
  <!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>${constants_1.PROJECT_NAME} B2B</title>
</head>
<body style="font-family: Arial, sans-serif; background-color: #ffffff; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 20px auto; border: 1px solid #ddd; border-radius: 8px; background-color: #ffffff;">
        <div style="background-color: #ececec; padding: 20px; text-align: center;">
            ...
            <h1 style="margin: 0; font-size: 24px; color: #202020;">Welcome to ${constants_1.PROJECT_NAME} B2B!</h1>
        </div>
        <div style="padding: 20px;">
            ...
            <div style="text-align: center; margin: 20px 0;">
                <a href="${constants_1.BTOB_URL}" style="display: inline-block; padding: 10px 20px; background-color: #007BFF; color: #ffffff; text-decoration: none; border-radius: 5px; font-size: 16px; font-weight: bold;">Log In</a>
            </div>
        ...
        <div style="background-color: #f2f2f2; padding: 20px; text-align: center; font-size: 14px; color: #555;">
            <p style="margin: 0;">If you have any questions, feel free to contact us at <a href=${constants_1.PROJECT_EMAIL_API_1} style="color: #0085D4; text-decoration: none;">${constants_1.PROJECT_NUMBER}</a>.</p>
            <p style="margin: 5px 0;">&copy; 2024 ${constants_1.PROJECT_NAME}. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
...
exports.newAgencyAccount = newAgencyAccount;
const AgencyRegistrationRequestApprovedTemplate = (email, password) => {
    return `<!DOCTYPE html>
    <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="text-align: center;"><a class="button" href="${constants_1.BTOB_URL}" target="_blank">Log In</a></p>
            <p>If you have any questions or need assistance, please don't hesitate to contact our support team.</p>
            <p>Best regards,<br/>The ${constants_1.PROJECT_NAME} B2B Team</p>
          </div>
        </div>
      </body>
    </html>`;
};
exports.AgencyRegistrationRequestApprovedTemplate = AgencyRegistrationRequestApprovedTemplate;
const AgencyRegistrationRequestRejectedTemplate = () => {
    return `<!DOCTYPE html>
    <html>
      <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>Best regards,<br/>The ${constants_1.PROJECT_NAME} B2B Team</p>
            <p style="text-align: center;"><a class="button" href="${constants_1.BTOB_URL}" target="_blank">VISIT WEBSITE</a></p>
          </div>
        </div>
      </body>
    </html>`;
};
exports.AgencyRegistrationRequestRejectedTemplate = AgencyRegistrationRequestRejectedTemplate;
