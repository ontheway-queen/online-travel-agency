...
exports.bankTransferSubmissionTemplate = void 0;
const constants_1 = require("../miscellaneous/constants");
const bankTransferSubmissionTemplate = () => {
    return `
   <!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <tr>
                         <td style="background-color: #F4F4F9; padding: 10px; text-align: center; font-size: 12px; color: #888;">
                            ...
                            <p style="margin: 5px 0;">Visit our website at 
                                <a href=${constants_1.CLIENT_URL} target="_blank" style="color: #0085D4; text-decoration: none;">${constants_1.CLIENT_URL}</a>.
                            </p>
                        </td>
                    </tr>
                </table>
...
exports.bankTransferSubmissionTemplate = bankTransferSubmissionTemplate;
