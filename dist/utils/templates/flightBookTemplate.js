...
exports.flightBookTemplate = void 0;
const constants_1 = require("../miscellaneous/constants");
const flightBookTemplate = (payload) => {
    const segmentRows = payload.segments
        ...
        return `
          ...
          <tr>
              ...
              <td style="border: 1px solid #ddd; padding: 10px;">${segment.airline}</td>
          </tr>
          <tr>
              <th style="border: 1px solid #ddd; padding: 10px; background-color: #f2f2f2; text-align: left;">Cabin</th>
              <td style="border: 1px solid #ddd; padding: 10px;">${segment.cabin}</td>
          </tr>
        `;
    })
        .join("");
          ...
          <div style="padding: 20px;">
              ...
              <table style="width: 100%; border-collapse: collapse; margin-top: 20px; font-size: 14px;">
                  ...
                  <tr>
                      ...
                      <td style="border: 1px solid #ddd; padding: 10px;">${payload.totalAmount}</td>
                  </tr>
                  ${segmentRows}
              </table>
          </div>
...
exports.flightBookTemplate = flightBookTemplate;
