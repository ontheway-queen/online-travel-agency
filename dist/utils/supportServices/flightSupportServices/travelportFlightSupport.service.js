...
// import { TRAVELPORT_API } from '../../miscellaneous/flightMiscellaneous/flightConstants';
// import { IMultipleApiPassengerBody } from '../../../features/public/utils/types/commonFlight.types';
// export default class TravelportFlightService extends AbstractServices {
//     private trx: Knex.Transaction;
//     private request = new TravelportRequest();
...
//                         let elapsed_time = 0;
//                         if (iterable_item) {
//                             const currentPrice = iterable_item.ProductBrandOffering[0].Price;
//                             console.log({currentPrice});
//                             //update the fare
//                             fare.base_fare += currentPrice.Base;
//                             fare.total_tax += currentPrice.TotalTaxes;
//                             fare.convenience_fee += currentPrice.TotalFees;
//                             fare.total_price += currentPrice.TotalPrice;
//                             // Update passengers price for the current item
//                             const currentPassengers = iterable_item.ProductBrandOffering[0].Price.PriceBreakdown.map((price_elem) => {
//                                 return {
...
//                                             flight_prod_elm.segmentSequence.includes(ind + 1)
//                                         )?.cabin,
//                                         baggage_count: first_check_bag_data.count + carry_on_bag_data.count,
//                                         baggage_unit: first_check_bag_data.unit,
//                                     });
//                                 });
...
//                     }
//                     // update convenience fee and discount if commission is available
//                     if (finalCom && finalComMode && finalComType) {
//                         if (finalComType === COM_TYPE_PER) {
//                             const comAmount = (fare.base_fare * finalCom) / 100;
//                             if (finalComMode === COM_MODE_INCREASE) {
//                                 fare.convenience_fee += comAmount;
//                             } else {
//                                 fare.discount += comAmount;
//                             }
//                         } else {
//                             if (finalComMode === COM_MODE_INCREASE) {
//                                 fare.convenience_fee += finalCom;
//                             } else {
//                                 fare.discount += finalCom;
//                             }
//                         }
//                     }
...
//         fare.convenience_fee += data.OfferListResponse.OfferID[0].Price.TotalFees;
...
//                         carrier_marketing_airline: marketing_airline.name,
//                         carrier_marketing_logo: marketing_airline.logo,
//                         carrier_marketing_flight_number: Number(segment_elem.Flight.number),
//                         carrier_operating_code: segment_elem.Flight.operatingCarrier || segment_elem.Flight.carrier,
//                         carrier_operating_airline: operating_airline.name,
//                         carrier_operating_logo: operating_airline.logo,
//                         carrier_operating_flight_number: Number(segment_elem.Flight.operatingCarrierNumber || segment_elem.Flight.number),
//                         carrier_aircraft_code: "",
//                         carrier_aircraft_name: ""
//                     }
//                 }
...
//     }: {
//         index: number,
//         data: IMultipleApiPassengerBody
...
//     }: {
//         api_search_id: any;
//         traveler: IMultipleApiPassengerBody[];
//     }) {
