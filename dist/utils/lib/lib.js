...
class Lib {
    ...
    static sendEmail(email, emailSub, emailBody, attachments) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const transporter = nodemailer_1.default.createTransport({
                    ...
                    auth: {
                        user: config_1.default.EMAIL_SEND_EMAIL_ID.trim(),
                        pass: config_1.default.EMAIL_SEND_PASSWORD.trim(),
                    },
                });
                const toEmails = Array.isArray(email) ? email.join(',') : email;
                const info = yield transporter.sendMail({
                    from: `${constants_1.PROJECT_NAME} <${config_1.default.EMAIL_SEND_EMAIL_ID.trim()}>`,
                    to: toEmails,
                    subject: emailSub,
                    html: emailBody,
    ...
    static getTimeValue(timeString) {
        ...
        let timeValue = (parseInt(hours, 10) * 60 * 60 + parseInt(minutes, 10) * 60 + parseInt(seconds, 10)) * 1000;
    ...
    //get route of flight
    static getRouteOfFlight(leg_description) {
        let route;
    ...
    static getJourneyDatesOfFlight(leg_description) {
        let journey_date;
    ...
    static getBookingCodeOfFlight(availability) {
        return ((availability === null || availability === void 0 ? void 0 : availability.flatMap((avElem) => {
            var _a;
            return (_a = avElem === null || avElem === void 0 ? void 0 : avElem.segments) === null || _a === void 0 ? void 0 : _a.map((segElem) => {
                var _a, _b;
                return ({
                    booking_code: (_a = segElem === null || segElem === void 0 ? void 0 : segElem.passenger[0]) === null || _a === void 0 ? void 0 : _a.booking_code,
                    cabin_type: (_b = segElem === null || segElem === void 0 ? void 0 : segElem.passenger[0]) === null || _b === void 0 ? void 0 : _b.cabin_type,
                });
            });
        })) || []);
    }
    //get flight class
    static getFlightClass(booking_code, booking_code_index, availability) {
        var _a, _b;
        return (`${(_a = booking_code === null || booking_code === void 0 ? void 0 : booking_code[booking_code_index]) === null || _a === void 0 ? void 0 : _a.cabin_type}(${(_b = booking_code === null || booking_code === void 0 ? void 0 : booking_code[booking_code_index]) === null || _b === void 0 ? void 0 : _b.booking_code})` ||
    ...
    static generateAuditMessage(req) {
        ...
        const id = (params === null || params === void 0 ? void 0 : params.id) || (body === null || body === void 0 ? void 0 : body.id) || '';
        ...
        switch (method) {
            case 'POST':
                ...
                if (endpoint === 'login') {
                    ...
                    message = `New message has been created for ${formattedEntity} (${id}) with information - ${formatBody(body)}.`;
                }
            ...
            case 'PATCH':
                type = 'UPDATE';
                message = `${formattedEntity} (${id}) has been updated with information - ${formatBody(body)}.`;
                break;
            case 'DELETE':
    ...
    static generateAlphaNumericCode(length) {
    ...
    static lastTimeFormat(message) {
        ...
        try {
            ...
            // Format 3
            const format3 = /ADV TKT NBR TO CX BY (\d{2})([A-Z]{3}) (\d{4}) (\w{3}) OR SUBJECT TO CANCEL/i;
