...
export const visaApplicationEmail = (payload: {
  name: string;
  visaType: string;
  destination: string;
...
export const template_onCreateVisaApp_sent_to_agent = (payload: {
  name: string;
  visaMode: string;
  destination: string;
  numOfTravellers: number;
...
export const template_onCreateVisaApp_sent_to_admin = (payload: {
  name: string;
  visaMode: string;
  destination: string;
  numOfTravellers: number;
