...
export const template_onCancelFlightBooking_send_to_user = (payload: {
  journey_type: string;
  route: string;
...
export const template_onCancelFlightBooking_send_to_agent = (payload: {
  journey_type: string;
  route: string;
  total_passenger: number;
  pnr: string;
...
export const template_onCancelFlightBooking_send_to_admin = (payload: {
  journey_type: string;
  route: string;
  total_passenger: number;
  pnr: string;
