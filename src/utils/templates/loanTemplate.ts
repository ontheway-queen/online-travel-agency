...
export const template_onLoanGiven_send_to_agency = (payload: {
  title: string;
  amount: number;
  date: string;
  remarks: string;
...
export const template_onLoanGiven_send_to_admin = (payload: {
  title: string;
  amount: number;
  date: string;
  remarks: string;
        ...
        <table style="max-width: 600px; width: 100%; background-color: #ffffff; padding: 20px; border-radius: 6px; box-shadow: 0 0 8px rgba(0,0,0,0.1);">
          <tr>
            <td style="text-align: center; padding-bottom: 20px;">
              <img src="${
                payload.logo || PROJECT_LOGO
              }" alt="Agency Logo" style="max-width: 140px;" />
...
export const template_onLoanRepayment_send_to_agency = (payload: {
  title: string;
  amount: number;
...
export const template_onLoanRepayment_send_to_admin = (payload: {
  title: string;
  amount: number;
  repaymentDate: string;
  remarks: string;
...
export const template_onLoanRequest_send_to_admin = (payload: {
  title: string;
  amount: number;
  date: string;
  remarks: string;
        ...
        <table style="max-width: 600px; width: 100%; background-color: #ffffff; padding: 20px; border-radius: 6px; box-shadow: 0 0 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding-top: 24px; text-align: center;">
              <a href="${
                payload.admin_url
              }" style="background-color: #007bff; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 4px; font-size: 15px;">
                Open Admin Panel
              </a>
            </td>
          </tr>
