...
import { IFlightTicketIssuePayload, IFlightTicketIssueSegmentPayload } from '../../utils/interfaces/flight/flightBookingInterface';
import Schema from '../../utils/miscellaneous/schema';

class B2BFlightTicketModel extends Schema {
  private db: TDB;
  constructor(db: TDB) {
    super();
    this.db = db;
  ...
  public async createFlightTicketSegment(payload: IFlightTicketIssueSegmentPayload) {
    return await this.db("flight_ticket_issue_segment")
      .withSchema(this.AGENT_SCHEMA)
      .insert(payload,'id');
  }
...
export default B2BFlightTicketModel;
