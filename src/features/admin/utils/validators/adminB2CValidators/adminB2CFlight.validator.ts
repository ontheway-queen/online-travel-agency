import Joi from "joi";
import { CUSTOM_API, FLIGHT_BOOKING_CANCELLED, FLIGHT_BOOKING_CONFIRMED, FLIGHT_BOOKING_IN_PROCESS, FLIGHT_BOOKING_ON_HOLD, FLIGHT_BOOKING_REFUNDED, FLIGHT_BOOKING_VOID, FLIGHT_TICKET_ISSUE, JOURNEY_TYPE_MULTI_CITY, JOURNEY_TYPE_ONE_WAY, JOURNEY_TYPE_ROUND_TRIP, PENDING_TICKET_ISSUANCE_STATUS, SABRE_API, TRIPJACK_API, VERTEIL_API } from "../../../../../utils/miscellaneous/flightMiscellaneous/flightConstants";


export class AdminB2CFlightValidator {
  ...
  public updateBooking = Joi.object({
    status: Joi.string().valid(FLIGHT_TICKET_ISSUE, FLIGHT_BOOKING_CANCELLED, FLIGHT_BOOKING_VOID, FLIGHT_BOOKING_REFUNDED, FLIGHT_BOOKING_CONFIRMED).required(),
    ...
    deduction_amount: Joi.number().min(1).when('status', {
