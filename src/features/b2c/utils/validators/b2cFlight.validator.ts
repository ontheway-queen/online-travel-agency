...
export default class B2CFlightValidator {
  ...
  public flightBookingPassengersSchema = Joi.object({
    reference: Joi.string().required().valid("MR", "MRS", "MS", "MASTER", "MISS", "MSTR"),
    ...
    contact_email: Joi.string().email().lowercase().trim().optional(),
  ...
  public flightBookingSchema = Joi.object({
    search_id: Joi.string().required(),
    flight_id: Joi.string().required(),
    passengers: Joi.array().items(this.flightBookingPassengersSchema.required()).required(),
  });
  ...
  public pnrCreateSchemaV2 = Joi.object({
    search_id: Joi.string().required(),
    flight_id: Joi.string().required(),
